            ...
            <div class="relative flex w-full max-w-[1502px] flex-col justify-between overflow-hidden rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 lg:min-h-[758px] lg:flex-row lg:gap-10 xl:gap-0">
                ...
                <div class="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                    ...
                    <div class="w-full max-w-[440px] lg:mt-16">
                        <div class="mb-10">
                            <h1 class="text-3xl font-extrabold uppercase !leading-snug text-primary md:text-4xl">{{ __('Reset Password') }}</h1>
                            <p class="text-base font-bold leading-normal text-white-dark">{{ __('Enter token and reset your password') }}</p>
                        </div>
                        <form method="POST" action="{{ route('resetPasswordSave') }}" class="space-y-5 dark:text-white" >
                            @csrf
                            <div>
                                <label for="">{{ __('Code') }}</label>
                                <div class="relative text-white-dark">
                                    <input name="token" id="" type="text" placeholder="Enter OTP code" class="form-input ps-10 placeholder:text-white-dark" />
                            ...
                            <div>
                                ...
                                <div class="relative text-white-dark">
                                    <input name="password_confirmation" id="password_confirmation" type="password" placeholder="Enter Password Again" class="form-input ps-10 placeholder:text-white-dark" />
                                    <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                            <path opacity="0.5"
                                                d="M1.5 12C1.5 9.87868 1.5 8.81802 2.15901 8.15901C2.81802 7.5 3.87868 7.5 6 7.5H12C14.1213 7.5 15.182 7.5 15.841 8.15901C16.5 8.81802 16.5 9.87868 16.5 12C16.5 14.1213 16.5 15.182 15.841 15.841C15.182 16.5 14.1213 16.5 12 16.5H6C3.87868 16.5 2.81802 16.5 2.15901 15.841C1.5 15.182 1.5 14.1213 1.5 12Z"

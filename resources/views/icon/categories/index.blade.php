<x-layout.default>
            ...
            <div class="px-5">
                <div class=" md:top-5 ltr:md:left-5 rtl:md:right-5">
                    <div class="flex items-center gap-2 mb-5">
                        <h5 class="font-semibold text-lg dark:text-white-light">{{ __('Category List') }}</h5>
                        <a href="{{ route('iconCategoryAddEdit') }}" class="btn btn-primary gap-2 float-right">
    ...
    <script>
        ...
        $.ajax({
            type: "POST",
            url: "{{ route('iconCategoryStatusUpdate') }}",
            data: {
                '_token': "{{ csrf_token() }}",
                'id': active_id
            },

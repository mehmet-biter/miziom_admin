                        ...
                        <li class="nav-item">
                            <a href="{{ "" }}" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{{ __('Job Category') }}</span>
                                </div>
                            </a>
                        </li>
                        @endif
                        ...
                        <li class="nav-item">
                            <a href="{{ route('jobPostList') }}" class="group">
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{{ __('Job Post') }}</span>
                                </div>
                            </a>
                        </li>
                        @endif
                        ...
                        <li class="nav-item">
                            <a href="{{ route('jobApplicationList') }}" class="group">
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{{ __('Job Application') }}</span>
                                </div>
                            </a>
                        </li>
                        @endif
                        ...
                        <li class="nav-item">
                            <a href="{{ route('teamList') }}" class="group">
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{{ __('Team') }}</span>
                                </div>
                            </a>
                        </li>
                        @endif
                        ...
                        <li class="nav-item">
                            <a href="{{ route('serviceList') }}" class="group">
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{{ __('Service') }}</span>
                                </div>
                            </a>
                        </li>
                        @endif
                        ...
                        <li class="nav-item">
                            <a href="{{ route('contactList') }}" class="group">
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{{ __('Contact List') }}</span>
                                </div>
                            </a>
                        </li>
                        @endif

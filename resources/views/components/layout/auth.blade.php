...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ settings('favicon') ? showImage(VIEW_IMAGE_PATH,settings('favicon')) : asset('assets/images/favicon.png')  }}" />
...
<body x-data="main" class="antialiased relative font-nunito text-sm font-normal overflow-x-hidden"
    ...
    <script src="{{asset('assets/common/toast/toastr.min.js')}}"></script> --}}

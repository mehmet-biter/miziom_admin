...
<head>
    ...
    <script type="text/javascript">window.$crisp=[];window.CRISP_WEBSITE_ID="2f47e492-a845-487e-9b47-53e5f3a3f0ae";(function(){d=document;s=d.createElement("script");s.src="https://client.crisp.chat/l.js";s.async=1;d.getElementsByTagName("head")[0].appendChild(s);})();</script>
</head>
...
<body x-data="main" class="antialiased relative font-nunito text-sm font-normal overflow-x-hidden"
    ...
    <div class="main-container text-black dark:text-white-dark min-h-screen" :class="[$store.app.navbar]">
        ...
        <div class="main-content-new flex flex-col min-h-screen">
            <x-common.general.header />

            <div class="mt-2 animate__animated" :class="[$store.app.animation]">
                {{ $slot }}
            </div>

            <x-common.general.footer />
        </div>
    </div>

        ...
        <div class="pt-5">
            <div class="grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-4 gap-5 mb-5">
                        ...
                        <ul class="mt-5 flex flex-col max-w-[160px] m-auto space-y-4 font-semibold text-white-dark">
                            ...
                            <li>
                                <a href="javascript:;" class="flex items-center gap-2">
                                    ...
                                    <span class="text-primary truncate">{{ $user->email }}</span></a>
                            </li>
                            <li class="flex items-center gap-2">
                                ...
                                <span class="whitespace-nowrap" dir="ltr">{{ $user->phone ? $user->phone : '+1 (530) 555-12121' }}</span>
                            </li>
                        </ul>
                ...
                <div class="panel lg:col-span-2 xl:col-span-3">
                    <div class="mb-5">
                        <h5 class="font-semibold text-lg dark:text-white-light">{{ __('Profile Information') }}</h5>
                    </div>
                    <div class="mb-5">
                            ...
                            <table class="whitespace-nowrap">
                                ...
                                <tbody class="dark:text-white-dark">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-danger">:</td>
                                        <td class="text-center">{{ $user->phone ? $user->phone : '+1 (530) 555-12121' }}</td>
                                    </tr>
                                    <tr>
                                        <td>{{ __('Role') }}</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-danger">:</td>
                                        <td class="text-center text-success">{{ __('Verified') }}</td>
                                    </tr>
                                    <tr>
                                        <td>{{ __('Phone Verification') }}</td>

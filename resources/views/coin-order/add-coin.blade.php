    ...
    <div >
        <div class="flex xl:flex-row flex-col gap-2.5">
            <div class="panel px-0 flex-1 py-6 ltr:xl:mr-6 rtl:xl:ml-6">
                ...
                <form method="POST" action="{{ route('adminSaveCoin') }}" enctype="multipart/form-data">
                 @csrf
                <div class="mt-8 px-4">
                    <div class="flex justify-between lg:flex-row flex-col">
                        <div class="lg:w-1/2 w-full ltr:lg:mr-6 rtl:lg:ml-6 mb-6">
                            ...
                            <div class="items-center mt-4">
                                <label for="status" class="ltr:mr-2 rtl:ml-2 w-1/3 mb-0">{{ __('Currency Type') }} <span class="text-danger">*</span></label>
                                <select id="currency_type" name="currency_type" class="form-select flex-1">
